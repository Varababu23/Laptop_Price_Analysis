...
IPS – IPS display support

RetinaDisplay – Retina display support
...
PrimaryStorage – Primary storage size

SecondaryStorage – Secondary storage size

PrimaryStorageType – Primary storage type (SSD/HDD)
...
Reviewed sample records to understand the data

Data Cleaning and Preprocessing

Converted RAM values from text format to numeric values

Converted weight values from string to float format
...
CPU and GPU impact on pricing

Storage type comparison (SSD vs HDD)

Display feature analysis (IPS, Retina, Touchscreen)
...
SSD storage significantly increases laptop price compared to HDD

Laptops with dedicated GPUs are more expensive

IPS and Retina displays contribute to higher pricing
...
Better understanding of how hardware specifications affect laptop pricing
